...
### 1.2 DispatcherServlet 初始化过程

DispatcherServlet 本质上是一个 Servlet，所以天然的遵循 Servlet 的生命周期。所以宏观上是 Servlet 生命周期来进行调度。

![img005](https://pet-hkw.oss-cn-shenzhen.aliyuncs.com/image/new_blog_system/framework/img005.png)
...
### 1.3 WDispatcherServlet 调用组件处理请求
...
2) DispatcherServlet 对请求 URL 进行解析，得到请求资源标识符（URI），判断请求URI对应的映射：
...
![img006](https://pet-hkw.oss-cn-shenzhen.aliyuncs.com/image/new_blog_system/framework/img006.png)

![img007](https://pet-hkw.oss-cn-shenzhen.aliyuncs.com/image/new_blog_system/framework/img007.png)

iii. 如果有配置，则访问目标资源（一般为静态资源，如：JS,CSS,HTML），找不到客户端也会展示404错误

![img008](https://pet-hkw.oss-cn-shenzhen.aliyuncs.com/image/new_blog_system/framework/img008.png)

![img009](https://pet-hkw.oss-cn-shenzhen.aliyuncs.com/image/new_blog_system/framework/img009.png)
